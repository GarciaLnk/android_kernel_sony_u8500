...
#define AB8500_SUPPORTED_FMT (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S32_LE)
...
/* REG_AUDINTSOURCE2 */
#define REG_AUDINTSOURCE2_VSSREADY		7
#define REG_AUDINTSOURCE2_SHORTHSL		2
#define REG_AUDINTSOURCE2_SHORTHSR		1
#define REG_AUDINTSOURCE2_SHORTEAR		0
