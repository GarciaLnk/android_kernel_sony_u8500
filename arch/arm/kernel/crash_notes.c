 ...
 *
 * Author: Bjorn Andersson <bjorn.andersson@sonyericsson.com>
 * Author: Henric Andersson <henric.andersson@sonyericsson.com>
 *
			      ...
			      unsigned long event, void *ptr)
{
	...
	if (num_online_cpus() > 1)
		printk(KERN_ERR "SMP: crash_notes notifier run while other "
			"CPU:s are still alive. This crash will be partly "
			"unflushed/corrupt\n");
...
int __init crash_notes_init(void)
{
	int i;
